...
<a href = "'.$this->routId->getDeleteQuizURL().'&amp;quizId='.$quiz["quiz_id"].'" class="btn btn-primary float-right" >Supprimer</a >
  ...
  <div class="card">
	...
	public function makeThemePage($table_theme){ //AFFICHE LES THEMES
        $this->title="Themes";
        $a='';
        $i=1;
    ...
    //Page that displays the quizzes available for a theme
...
';
    ...
    //Validates the saving of user responses
